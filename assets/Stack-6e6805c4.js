...
`,n.jsx(r.h2,{id:"주의사항",children:"주의사항"}),`
`,n.jsxs(r.ul,{children:[`
`,n.jsxs(r.li,{children:[n.jsx(r.code,{children:"Stack"}),"은 자식 요소에 애니메이션을 삽입하므로 겹치지 않게 주의해주세요!"]}),`
`,n.jsxs(r.li,{children:["JSX 상에서 ",n.jsx(r.code,{children:"Stack"}),"의 직속 자녀들만을 대상으로 합니다."]}),`
`]}),`
`,n.jsx(r.h2,{id:"props",children:"Props"}),`
`,n.jsx(r.p,{children:"Control의 결과는 Playground에서 확인 가능합니다!"}),`
`,n.jsx(p,{of:i}),`
`,n.jsx(r.h2,{id:"예제",children:"예제"}),`
`,n.jsx(r.pre,{children:n.jsx(r.code,{className:"language-tsx",children:`import { Stack } from '@pium/stack-component';\r
\r
<Stack\r
  as="main"\r
  showCount={2}\r
  ...
  rowGap="2rem"\r
  time={777}\r
  justifyItems="center"\r
>\r
  <p>새는 자기 길을 안다</p>\r
  <p>김종해</p>\r
  <p>하늘에 길이 있다는 것을</p>\r
  <p>새들이 먼저 안다</p>\r
  <p>하늘에 길을 내며 날던 새는</p>\r
  <p>길을 또 지운다</p>\r
  <p>새들이 하늘 높이 길을 내지 않는 것은</p>\r
